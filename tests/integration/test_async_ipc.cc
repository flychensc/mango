...
namespace
{
    ...
    private:
        ...
        {
            std::shared_ptr<mango::Builder> builder = std::make_shared<mango::AsyncExecutorServiceBuilder>("/tmp/rpc_service");
        ...
        {
            std::shared_ptr<mango::Builder> builder = std::make_shared<mango::CallerBuilder>("/tmp/rpc_caller");
            mango::Director director;
            director.setBuilder(builder);
            ...
            rpc_caller->Connect("/tmp/rpc_service");
        }
